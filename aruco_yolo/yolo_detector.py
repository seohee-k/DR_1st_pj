...
# model_path = 'D_1_best.pt'
# model_path = '~/turtlebot3_ws/src/aruco_yolo/aruco_yolo/yolov8s_trained.pt'
...
model_path = "/home/rokey/turtlebot3_ws/src/aruco_yolo/models/new_new_new_best.pt"
...
class YoloDetect(Node):
    ...
    def inference(self, img_color, pix_2_mm):
        results = self.model(img_color, conf=0.8)
