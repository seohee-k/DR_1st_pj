        ...
        while(rclpy.ok()):
            ...
            if key_value == '1':
                ...
                if node.trajectory_msg.points[0].positions[0] < 2.79:
                    ...
                    node.joint_pub.publish(node.trajectory_msg)
                    print('joint1 +')
                    print(f'{node.trajectory_msg.points[0].positions[0]}')
                    print(f'{node.trajectory_msg.points[0].positions[1]}')
                    print(f'{node.trajectory_msg.points[0].positions[2]}')
                    print(f'{node.trajectory_msg.points[0].positions[3]}')
                else:
